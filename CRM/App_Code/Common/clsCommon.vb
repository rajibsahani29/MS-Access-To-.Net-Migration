...
Public Class clsCommon
    ...
    Public Function ValidateLogin() As Boolean
        Try
            If HttpContext.Current.Request.Cookies("LoginDetail") IsNot Nothing Then
                Dim strCookieName As String = "LoginDetail"
                If String.IsNullOrEmpty(Convert.ToString(HttpContext.Current.Request.Cookies(strCookieName)("UserId"))) OrElse String.IsNullOrEmpty(Convert.ToString(HttpContext.Current.Request.Cookies(strCookieName)("UserName"))) Then
                    Return False
                Else
                    Return True
                End If
            ElseIf String.IsNullOrEmpty(Convert.ToString(HttpContext.Current.Session("LoginUserName"))) OrElse String.IsNullOrEmpty(Convert.ToString(HttpContext.Current.Session("LoginUserFirstName"))) OrElse String.IsNullOrEmpty(Convert.ToString(HttpContext.Current.Session("UserName"))) Then
                Return False
            Else
                Return True
            End If
    ...
    Public Function ValidateLoginMobile() As Boolean
        Try
            If HttpContext.Current.Request.Cookies("LoginDetailMobile") IsNot Nothing Then
                Dim strCookieName As String = "LoginDetailMobile"
                If String.IsNullOrEmpty(Convert.ToString(HttpContext.Current.Request.Cookies(strCookieName)("UserId"))) OrElse String.IsNullOrEmpty(Convert.ToString(HttpContext.Current.Request.Cookies(strCookieName)("UserName"))) Then
                    Return False
                Else
                    Return True
