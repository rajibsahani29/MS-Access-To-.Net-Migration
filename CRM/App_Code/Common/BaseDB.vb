...
Public Class BaseDB
    ...
    ''' <summary>
    ''' This function is used to execute query to get result and it return Datatable.
    ''' </summary>
    Protected Function FillDataSetByCommandTable(ByVal cmdCommand As SqlCommand, ByVal strFunction As String) As DataTable
