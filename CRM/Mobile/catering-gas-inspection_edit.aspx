<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Mobile/Mobile.Master" CodeBehind="catering-gas-inspection_edit.aspx.vb" Inherits="CRM.catering_gas_inspection_edit" %>
                                            ...
                                            <table class="table color-table primary-table radio-table">
                                                ...
                                                <thead>
                                                    <tr>
                                                        <td>&nbsp;</td>
                                                        <td>
                                                            <asp:Button ID="btnSubmitAppliance" runat="server" CssClass="btn btn-outline-success btn-rounded" Text="Submit" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>&nbsp;</td>
                                                        <td>
                                                            <asp:Button ID="btnInspection" runat="server" CssClass="btn btn-outline-success btn-rounded" Text="Submit" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="2">
                                                            ...
                                                            <asp:GridView ID="grdInspection" runat="server" AutoGenerateColumns="False"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Is An Isolation Valve Fitted?(Y/N)">
                                                                        ...
                                                                        <EditItemTemplate>
                                                                            <asp:TextBox ID="txtSafeToUse" runat="server" Text='<%#Eval("SafeToUse")%>' />
                                                                        </EditItemTemplate>
                                                                    </asp:TemplateField>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>&nbsp;</td>
                                                        <td>
                                                            <asp:Button ID="btnSaftety" runat="server" CssClass="btn btn-outline-success btn-rounded" Text="Submit" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="2">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>&nbsp;</td>
                                                        <td>
                                                            <asp:Button ID="btnSubmitWork" runat="server" CssClass="btn btn-outline-success btn-rounded" Text="Submit" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="2">
