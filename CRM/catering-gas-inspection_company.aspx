<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main.Master" CodeBehind="catering-gas-inspection_company.aspx.vb" Inherits="CRM.catering_gas_inspection_company" %>
        ...
        <!-- ============================================================== -->
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor">Catering Gas Inspection - Select Company</h4>
                </div>
            ...
            <div class="company-form">
                ...
                ShowHeaderWhenEmpty="True" CssClass="table table-striped clsResizeColumn" CellPadding="4" ForeColor="#333333" GridLines="None" AllowPaging="True" PageSize="10">
                ...
                <asp:CommandField ShowSelectButton="true" ItemStyle-ForeColor="Red" SelectText="Show Details" HeaderText="Information"/>
